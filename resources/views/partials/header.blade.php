<nav class="navbar navbar-expand-lg align-items-center bg-white"
     id="navbar">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse mb-xl-0 mx-5 mb-3"
             id="navbarText">
            <ul class="navbar-nav me-auto mb-lg-0 gap-xl-5 mb-2">
                <li class="nav-item">
            ...
            <div class="nav-item d-flex float-end align-items-center">
                @auth
                    ...
                    <a href="/dashboard"
                       class="nav-link">{{ __('nav.dashboard') }}</a>
                    <form action="/logout"
                          method="post">
                        @csrf
                        <button type="submit"
                ...
                @else
                    {{-- when not logged in --}}
                    <a href="/login"
                       class="nav-link">{{ __('nav.login') }}</a>
                    <a href="/register"
                       class="nav-link">{{ __('nav.register') }}</a>
                @endauth
            </div>
        </div>
    </div>
